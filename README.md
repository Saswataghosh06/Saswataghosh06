# 👋 Hey there, I’m Saswata Ghosh  

💡 **Product Designer | UI/UX Designer | Frontend Developer**  
🎯 Designing human-centered experiences that merge storytelling, design systems, and data-driven insights.  
...
With a unique blend of design thinking and frontend development, I craft user interfaces that not only **look beautiful** but also **perform efficiently**.  
...
- Migrated static HTML/CSS/JS website to a dynamic WordPress platform (Astra + Elementor) improving SEO score from **45 → 97**.  
- Increased organic impressions by **70%** and page speed by **50%** using structural optimization & GSC insights.  
- Integrated Google Analytics for audience behavior & performance tracking.  
- Collaborated on an **MDM platform**—optimizing UI/UX workflows and dashboards.  
...
- Improved obstacle detection accuracy by **95%** through iterative feedback and prototyping.  

**📰 Web Developer – Newscope (Nov 2024 – Mar 2025)**  
- Built dynamic news platform with **React** and **REST APIs**, enhancing UX & accessibility.  
